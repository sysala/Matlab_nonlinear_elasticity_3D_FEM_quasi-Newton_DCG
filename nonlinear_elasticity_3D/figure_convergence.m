function figure_convergence(X1, Y1, X2, Y2, X3, Y3, X4, Y4)
...
%  X4:  vector of semilogy x data
%  Y4:  vector of semilogy y data
...
% Create semilogy
semilogy(X4,Y4,'DisplayName','q-Newton 3','Marker','*','LineWidth',1,...
