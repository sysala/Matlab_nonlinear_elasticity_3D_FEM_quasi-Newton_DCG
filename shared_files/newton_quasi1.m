function [U, it, crit_hist, omega_hist] = newton_quasi1(U_ini, WEIGHT, K_V, K_elast, B, f, Q, shear, bulk, alpha, gamma, eps)
    ...
    while true
        ...
        [S, DS_D, m, M] = constitutive_problem_quasi1(E, shear, bulk, alpha, gamma, eps);
        % solution of the constitutive problem
